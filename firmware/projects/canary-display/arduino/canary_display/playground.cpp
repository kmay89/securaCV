...
#include "mode_glue.h"  // long-press exit: clear both latches, reboot
#endif
...
#include "lvgl_port.h"
#include "version.h"
#include "modbus_rtu.h"   // RS485 station: pure Modbus RTU framing/CRC
#include "can_frame.h"    // CAN station: pure frame model + formatter
