...
// this project) and 1.4.x (core 2.x, canary-vision) differ on init()/
// setAdvertisementData() return types and isInitialized(); the
// ESP_ARDUINO_VERSION_MAJOR split mirrors
