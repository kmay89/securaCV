...
//
// Cross-core: NimBLE-Arduino 2.x (arduino-esp32 core 3.x / pioarduino fork,
// this project) and 1.4.x (core 2.x, canary-vision) differ on the scan-callback
// shape, isInitialized() and start(); the ESP_ARDUINO_VERSION_MAJOR split
// mirrors firmware/projects/canary-display/src/net/chirp_scan.cpp.
