// Host-side test for fleet_beacon.h — the direct BLE "fleet link" presence
// beacon builder/parser. Pure header, no NimBLE/Arduino glue: the test
// includes it directly and asserts the exact 9-byte payload the WAP puts on
// air (bytes [2..10] of the on-air manufacturer blob; NimBLE prepends the
// 2 company bytes). The DISPLAY side parses the identical layout in
// canary-display/include/canary/net/beacon_parse.h.

#include "../arduino/canary_wap/fleet_beacon.h"
