...
// changing the string would fork the crypto. The C constant was renamed to its
...
// unit's stored identity. The C constants were renamed to their fleet names;
// the stored key strings are deliberately unchanged.
