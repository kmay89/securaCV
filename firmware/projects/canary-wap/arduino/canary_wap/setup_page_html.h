 ...
 *
 * canary.local is purposely NOT a hyperlink: tapping a link inside the captive
 * sheet would load the wizard back inside the mini-browser (white screen
 * again). It's shown as instruction text so the user opens their browser.
 *
