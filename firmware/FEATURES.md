...
| SoftAP WPA2/WPA3 transition + PMF capable (F16; WPA2 where the core lacks SoftAP SAE, reported as `ap_auth`; CI compile pending, no bench) | ⚠️ | ⚠️ | ❌ | ❌ | ❌ | ➖ | ❌ |
...
| TLS (HTTPS self-signed; canary (PIO): dev/full CI compile pending, release pending slot budget, no bench) | ⚠️ | ❌ | ❌ | ❌ | ❌ | ➖ | ✅ |
| Watchdog timer | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| TLS (HTTPS) support | ✅ Self-signed cert | ❌ | ⚠️ ECDSA P-256 self-signed, `FEATURE_HTTPS` in dev/full (CI compile pending, release pending slot budget, no bench) | ❌ |
