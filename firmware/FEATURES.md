...
| Capability | canary (PIO) | canary-wap (Arduino) | canary-wap (PIO) | canary-vision | canary-sense | canary-display | canary-ota | snapshot (archived) |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
| Chirp channel (broadcast beacon) | ⚠️ | ✅ | ⚠️ | ❌ | ❌ | ⚠️ | ➖ | ✅ |
