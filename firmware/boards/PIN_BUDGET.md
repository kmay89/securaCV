...
⚠ 4 pin define(s) are `-1` — not wired OR not yet verified (see the comments in pins.h): `BUZZER_PIN`, `IMU_PIN_INT1`, `PWR_KEY_PIN`, `TFT_PIN_MISO`. Free counts above may shrink as these resolve.
