...
a row each, the way round glass always has; a stuck-phone hint ("forget it on
your phone") takes the key's row while it stands. No row is ever cut to an
ellipsis — when the QR does not scan, that text is the only way in (F45).
