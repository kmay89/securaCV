...
- **Research:** [bitchat protocol](research/bitchat_protocol_review.md) · [display market](research/display_market_research.md) · [harm-reduction prior art](research/harm_reduction_prior_art.md) · [pool water monitor](research/pool_water_monitor.md) · [Whisper local voice](research/whisper_local_voice.md)
