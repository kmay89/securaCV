...
- [Apple Home via the HA HomeKit Bridge](integrations/home-assistant-homekit-bridge.md) — your Canaries in the Home app with no new code; says plainly where this lane is un-paced and when to use the native one instead
...
- **Research:** [bitchat protocol](research/bitchat_protocol_review.md) · [display market](research/display_market_research.md) · [harm-reduction prior art](research/harm_reduction_prior_art.md) · [pool water monitor](research/pool_water_monitor.md)
