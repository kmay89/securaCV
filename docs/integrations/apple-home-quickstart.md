...
| Tamper | Status on each sensor | **always** — cannot be turned off |
| Responding | Status on each sensor | yes |
| Low battery | Status on each sensor | yes |
| Motion (person) | Motion sensor | **no** — you must ask for it |
| Motion (vehicle) | Motion sensor | **no** — you must ask for it |
| Motion (animal) | Motion sensor | **no** — you must ask for it |
| Motion (package) | Motion sensor | **no** — you must ask for it |
