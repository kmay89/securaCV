...
- **Two firmware fixes HA18 turned up (PR #<E>, sweeps HA19 and HA21).**
  HA18's sweep of the other fingerprint readers found the first, and its
  review the second. The canary-display's fleet model keeps a canary-wap's
