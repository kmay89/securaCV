...
def _tamper_sensor(kind: str, name: str):
    return _entity(bs_platform.SecuraCVCanaryTamperTypeSensor, kind, name, "mdi:alert")


def test_tamper_bridge_body_lights_the_named_sensor_only() -> None:
    removed = _tamper_sensor(TAMPER_SD_REMOVE, "SD Removed")
    enclosure = _tamper_sensor(TAMPER_ENCLOSURE, "Enclosure Open")
...
def test_touch_drain_payload_lights_enclosure_open_and_keeps_kind() -> None:
    ...
    other = _tamper_sensor(TAMPER_ENCLOSURE, "Enclosure Open")
