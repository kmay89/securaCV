...
<!-- TODO: add a screenshot of the verified ✓ event timeline + daily digest here -->
...
- If you ever need to prove what happened, **break the glass** — a multi-party authorization
  that requires your chosen trustees to approve access. Not even the administrator can tamper
  with the log.
